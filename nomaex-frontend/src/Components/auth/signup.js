          ...
          <form className="text-center border border-light p-5 rounded bg-light" onSubmit={this.handleSubmit}>
            ...
            <div className="form-row mb-4">
              <div className="col">
                ...
                <input type="text" id="defaultRegisterFormFirstName" name="firstName" className="form-control" placeholder="First name" required pattern=".{3,}" title="First name should have at least 3 characters" onChange={this.handleChange} />
              </div>
              <div className="col">
                {/* Last name */}
                <label htmlFor="lastName">Last Name: </label>
                <input type="text" id="defaultRegisterFormLastName" name="lastName" className="form-control" placeholder="Last name" required pattern=".{3,}" title="Last name should have at least 3 characters" onChange={this.handleChange} />
              </div>
            </div>

            {/* E-mail */}
            <label htmlFor="email">Email: </label>
            <input type="email" id="defaultRegisterFormEmail" name="email" className="form-control mb-4" placeholder="E-mail" required onChange={this.handleChange} />
            ...
            <input type="password" id="defaultRegisterFormPassword" className="form-control" placeholder="Password" required
            ...
            <input type="password" id="defaultRegisterFormPassword" className="form-control" placeholder="Confirm Password" required
              pattern=".{8,}" aria-describedby="defaultRegisterFormPasswordHelpBlock" onChange={this.handleChange} />
            <br />
